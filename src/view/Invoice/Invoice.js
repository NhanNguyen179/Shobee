  ...
  handleAddLineItem = (event) => {
    this.setState({
      ...
      lineItems: this.state.lineItems.concat(
        [{ id: 1, name: '', description: '', quantity: 0, price: 0.00 }]
      )
    })
  }
      ...
      <div className={styles.invoice}>
        ...
        <div className={styles.addresses}>
          <div className={styles.from}>
            <strong>Nguyễn Văn Nhân</strong><br />
              Nguyễn Xuân Hữu<br />
        ...
        <div className={styles.totalContainer}>
          ...
          <form>
            <div className={styles.valueTable}>
              ...
              <div className={styles.row}>
                <div className={styles.label}>Giảm giá: ({this.state.taxRate}%)</div>
                <div className={`${styles.value} ${styles.currency}`}>{this.formatCurrency(this.calcTaxTotal())}</div>
              </div>
              <div className={styles.row}>
                <div className={styles.label}>Thành tiền: </div>
